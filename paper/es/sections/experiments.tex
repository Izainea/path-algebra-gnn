...
la precisión en el objetivo sobre cinco semillas, en profundidades $d\in\{2,3\}$ con
$K=5$, $M=4$.
...
como $4^{\,n/2}$ con el tamaño del anillo. La tarea requiere $n/2$ saltos, y por tanto
$n/2$ capas en un modelo de un salto. Usamos cinco clases (azar $0.2$), el mismo
...
arcos, y los pesos aprendidos identifican la etiquetada. La brecha se
amplía con el tamaño del anillo, esto es, con la severidad del over-squashing, como se predijo.
...
recuperación necesita. En este régimen los caminos redundantes son \emph{señal}, no
...
las supera aquí}: supera claramente a GCN y es indistinguible de
GAT. No se debe a la ausencia de caminos paralelos: los
...
con datos reales, el operador sigue entrenando de forma estable y barata.
